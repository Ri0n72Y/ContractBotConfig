...
OpenContracts 读取/上传/核验规则由 Operator Persona、Handoff Policy、OpenContracts Gateway 和 Result Guard 共同承担；合同生成规则由 Builder Persona 与 Generation Flow 承担，不再重复打包对应 Skill。
